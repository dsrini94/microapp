...
import { FlatList, View, Image, Text, StyleSheet, TouchableOpacity, Modal, Dimensions } from 'react-native';
...
export default class ScreenShots extends Component {
  ...
  render() {
    const data = [
      {
        imageUrl: 'https://cdn6.f-cdn.com/contestentries/487835/19488362/575b003503322_thumb900.jpg',
        title: 'Introduction to DevOps',
        desc: 'Login Page with Google Sign In',
        id: '1',
      },
      {
        imageUrl: 'http://gdj.graphicdesignjunction.com/wp-content/uploads/2014/03/009_sign_in_app_design.jpg',
        title: 'Introduction to Docker',
        desc: 'Horizontal Image slider',
        id: '2',
      },
      {
        imageUrl: 'https://i.pinimg.com/736x/e9/35/30/e93530f69a0b8f8845b3574cf806fc88--mobile-app-apps.jpg',
        title: 'Journey Map',
      ...
      <View>
        <FlatList
          ...
          renderItem={({ item: rowData }) => (
            <TouchableOpacity onPress={() => this.setState({ modalVisible: true, selectedImage: rowData.imageUrl })}>
