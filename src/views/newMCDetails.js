          ...
          <View key={rowData} style={styles.container2}>
            ...
            <View style={styles.ssContainer}>
              <View style={styles.flatListSwiper}>
                <Text style={styles.ssText}>Sample Screenshots</Text>
                <ScreenShots />
              </View>
            </View>
 ...
 position: 'absolute',
            ...
            renderForeground={() => (
              <View key="parallax-header" style={styles.parallaxHeader}>
                <Image style={styles.avatar} source={require('./../../images/red.jpg')} style={{ width: AVATAR_SIZE, height: AVATAR_SIZE, borderRadius: AVATAR_SIZE / 2 }} />
