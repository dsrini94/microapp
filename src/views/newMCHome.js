...
export default class MCHome extends Component {
  ...
  componentDidMount() {
    fetch(
      "http://ec2-13-126-105-122.ap-south-1.compute.amazonaws.com:8080/microcomponents"
    )
        ...
        <ScrollView style={styles.scrollContainer}>
          ...
          >
            <GridView
              ...
              renderItem={item => (
                <TouchableOpacity style={styles.loadingContainer} onPress={()=>this.props.navigation.navigate('MCPage',{
                  details:item
                })}>
